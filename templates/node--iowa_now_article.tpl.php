...
<article id="node-<?php print $node->nid; ?>" class="<?php print $classes; ?> clearfix"<?php print $attributes; ?>>
  ...
  <?php if ($title && !$page): ?>
    <?php if (!empty($content['field_iowanow_url']['0']['#markup'])): ?>
      <?php $iowa_now_url = $content['field_iowanow_url']['0']['#markup']; ?>
      <?php $node_url = $iowa_now_url; ?>
      <?php $content['links']['node']['#links']['node-readmore']['href'] = $iowa_now_url ?>
    <?php endif; ?>
    <?php if (!empty($content['field_iowanow_external_url']['0']['#markup'])): ?>
      <?php $external_url = $content['field_iowanow_external_url']['0']['#markup']; ?>
